...
import {
  ...
  DESKTOP_LOCAL_MODEL_ADD_PATH,
  DESKTOP_LOCAL_MODEL_SELECT_PATH,
  DESKTOP_LOCAL_MODEL_REMOVE_PATH,
  DESKTOP_LOCAL_MODEL_CONFIGURE_PATH,
  DESKTOP_LOCAL_MODEL_START_PATH,
  DESKTOP_LOCAL_MODEL_STOP_PATH,
...
import {
  ...
  handleDesktopLocalModelRemoveRequest,
  handleDesktopLocalModelConfigureRequest,
  handleDesktopLocalModelStartRequest,
  handleDesktopLocalModelStopRequest,
...
export function apply(ctx: Context, config: Config): void {
  ...
  if (desktopSettings !== undefined) {
    ...
    const settingsRoutes = [
      ...
      [DESKTOP_LOCAL_MODEL_ADD_PATH, handleDesktopLocalModelAddRequest],
      [DESKTOP_LOCAL_MODEL_SELECT_PATH, handleDesktopLocalModelSelectRequest],
      [DESKTOP_LOCAL_MODEL_REMOVE_PATH, handleDesktopLocalModelRemoveRequest],
      [DESKTOP_LOCAL_MODEL_CONFIGURE_PATH, handleDesktopLocalModelConfigureRequest],
      [DESKTOP_LOCAL_MODEL_START_PATH, handleDesktopLocalModelStartRequest],
      [DESKTOP_LOCAL_MODEL_STOP_PATH, handleDesktopLocalModelStopRequest],
